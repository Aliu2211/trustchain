...
export function SignupForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Call the login function from auth context to auto-login after signup
      login({
        id: "1",
        email: formState.email,
        name: "TrustChain User",
      })
    ...
    >
      <Card className="bg-slate-900/60 border-slate-800 shadow-xl shadow-purple-500/5 overflow-hidden backdrop-blur-md hover:shadow-purple-500/10 transition-all duration-500 group">
        <CardHeader className="pb-2 border-b border-slate-800/50">
          ...
          <CardDescription className="text-slate-400">Join the decentralized reputation network</CardDescription>
        </CardHeader>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => setFormState({ ...formState, acceptTerms: checked as boolean })}
